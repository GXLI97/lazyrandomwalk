...
Preprocess the data by running ``src/preprocess.sh``. You may need to set the env var to point to the right data directory/files if they are not in default locations.
